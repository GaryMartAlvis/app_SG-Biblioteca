...
# Descripción
Aplicación de terminal desarrollada con python para gestionar una biblioteca. La aplicación permite administrar de manera eficiente la gestión de libros y usuarios de una biblioteca, entre los trabajos que se puede realizar en la aplicación esta: 

**Administración de libros:** En el nivel de menú "LIBRO" se encuentran las opciones para agregar libro, mostrar libros, ver descripción del libro, prestar libro y devolver libro.

**Gestión de usuarios:** En el nivel de menú "USUARIO" se encuentran las opciones para registrar usuarios, listar usuarios y listado de los libros prestados por usuario.

**Configuraciones:** En el nivel de menú "CONFIG." se encuentra las opciones de guardar datos, cargar datos y salir de la aplicación.
